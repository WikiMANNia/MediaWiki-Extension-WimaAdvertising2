...
class GoogleAdvertisingSettings {
	...
	private function __construct() {
		...
		global $wgWimaGoogleAdSense_Left;
		global $wgWimaGoogleAdSense_Right;
		global $wgWimaGoogleAdSense_Bottom;

		$this->mDefaultType = 'advertising';
		$Ad_Top    = self::getAdConfigArray( $wgWimaGoogleAdSense_Top );
		$Ad_Left   = self::getAdConfigArray( $wgWimaGoogleAdSense_Left );
		$Ad_Right  = self::getAdConfigArray( $wgWimaGoogleAdSense_Right );
